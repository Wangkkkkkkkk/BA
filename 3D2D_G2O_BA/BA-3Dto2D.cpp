...
string p3d_file = "/home/kai/BA/3D2D_G2O_BA/data/p3d.txt";
string p2d_file = "/home/kai/BA/3D2D_G2O_BA/data/p2d.txt";
...
//    optimizer.setAlgorithm ( solver );
    ...
    g2o::Vector3D t;
    t << 0, 0, 0;
    g2o::SE3Quat pose = g2o::SE3Quat(R, t);
    ...
    cout<< "g2o optimizer time: " << mTimeG2Ooptimizer <<endl;

    // 输出优化结果
    cout<<endl<<"after optimization:"<<endl;
    g2o::VertexSE3Expmap* vSE3_recov = static_cast<g2o::VertexSE3Expmap*>(optimizer.vertex(0));
    cout<<"T="<<endl<<Eigen::Isometry3d ( vSE3_recov->estimate() ).matrix() <<endl;
}